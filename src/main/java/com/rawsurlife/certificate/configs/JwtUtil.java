...
public class JwtUtil {
	...
	private String doGenerateToken(Map<String, Object> claims, String subject) {
        ...
        final Date expirationDate = new Date( System.currentTimeMillis() + this.jwtExpirationInMs );
        
        System.err.println("Created At : " + createdDate );
        System.err.println("Expiration At : " + expirationDate );
